...
<html >
   ...
   <body>
    ...
    <!--Deleting a waiting list record-->
            ...
            <div class="row">
               <div class="col-lg-12 col-md-12 col-sm-12 "  >
                  <div class="jumbotron" style="background-color:#e5b75b; padding-top: 10px; padding-bottom: 30px;
                     ...
                     <form class="form-horizontal" name="myform" action="delete_waiting1.php" method="post">
                        ...
                        <div class="form-group">
                           <div  class="col-sm-offset-4 col-sm-10"><a href="waiting_table.php"> GO BACK </a></div>
                        </div>
                     </form>
                  </div>
               </div>

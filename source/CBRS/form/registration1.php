         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav navbar-right">
                  ...
                  <li role="presentation"><a href="../rules/commonrules1.php">Rules And Regulations</a></li>
                  <li role="presentation"><a href="../tables/reservation_table.php">Check Reservations</a></li>
               ...
               <div class="container">
                  <div class="col-xs-12 col-md-7">
                     <div class="modal-content" style="margin-top:25px">
                        ...
                        <form  id="registrationForm" action="check_waitinglist1.php" method="post" name = "myform" style= "background-color:#faf2e0;margin-top:15px"  class="form-horizontal" role="form">
                           <div class="modal-body">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-md-7">
                                    <input type="text" class="form-control" name="branch" id="branch" required size="30" onchange="branch_check();" >
                                 </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-md-7">
                                    <input type="text" class="form-control" name="no_of_people" id="no_of_people" required  size="30" onchange="no_of_people_check();">
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label class="control-label col-md-3" for="email">Email: </label>
                                 <div class="col-md-7">
                                    <input type="text" class="form-control" id="email" name="email" required  size="30">
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label class="control-label col-md-3" for="contact_no">Mobile No: </label>
                                 <div class="col-md-7">
                                    <input type="text" class="form-control" name="contact_no" id="contact_no" required size="30" onchange="mobcheck();">
                                 </div>
                              </div>
                              <div class="form-group">

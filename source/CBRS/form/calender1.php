<?php
   ...
   $select_month_control = '<form class="form-horizontal"  role="form"><div class="form-horizontal" ><select  class="form-control" name="month" id="month">';
   for($x = 1; $x <= 12; $x++) {
   ...
   /* select year control */
   $year_range = 7;
   $select_year_control = '<form class="form-horizontal"  role="form"><select   class="form-control" name="year" id="year">';
   ...
   $select_bun_control = '<form class="form-horizontal"  role="form"><select style="margin-top:-40px;" class="form-control" name="bun" id="bun">';
   $bun_list = array("ambalanthota", "anuradhapura", "badulla", "bandarawela", "beliatta", "chawakachcheri", 
   "dambulla", "galle", "kandy", "katharagama", "mahiyangana", "maravila", "nuwaraEliya", "nuwaraEliyaNew");
   ...
   $events = array();
     if($month < 10) {
   	...
   	$query = "SELECT id, Arrival_Date, Departure_Date FROM reservation_table WHERE Arrival_Date LIKE '$year-$month%' and Circuit_Bungalow='$bun'";

            ...
            if(isset($events[$event_day])) {
                foreach($events[$event_day] as $event) {
                    $calendar.= '<div class="event"  style="position:absolute;
															...
															top:-5px;
															padding-right: 25px;
				padding-bottom:15px;">'.$event['id'].'</div>';
...
$cont1='<form method="get">'.$previous_month_link.' </form>';
$cont2='<form method="get">'.$next_month_link.' </form>';
...
echo '<div class="cont1">'.$cont1.'</div>';
echo '<div class="cont2">'.$cont2.'</div>';
